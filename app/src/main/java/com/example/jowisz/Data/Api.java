...
//    private static final String ROOT_URL = "http://192.168.1.104:8080/ShopApi/v1/Api.php?apicall=";  //uczelnia
//    private static final String ROOT_URL = "http://192.168.64.2:80/ShopApi/v1/Api.php?apicall=";
    ...
    public static final String URL_READ_LAST_ID = ROOT_URL + "getLastIDFromZamowienie";
    public static final String URL_CREATE_ZAMOWIENIE = ROOT_URL + "createzamowienie";
    public static final String URL_CREATE_ZAMOWIENIE_SPRZETU = ROOT_URL + "createzamowieniesprzetu";
